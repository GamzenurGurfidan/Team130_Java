...
public class C03_VarilenSoyismeSahipOgrenciListesiYazdirma {
    public static void main(String[] args) {
        ...
        for (Integer eachKey : ogrenciKeySet) {
            ...
            if (valueEachArr[1].contains(istenenSoyisim)) {
                System.out.println(eachKey + " numaralı ogrencinin ismi:  " + valueEachArr[0]
                        + ", bolumu: " + valueEachArr[4]);
            }
