...
public class C06_NestedMap {
    public static void main(String[] args) {
        ...
        /*
            {101={Bolum=MF, Soyisim=Can, Sube=H, Sınıf=11, Isim=Ali},
            102={Bolum=TM, Soyisim=Cem, Sube=K, Sınıf=10, Isim=Veli},
            103={Bolum=TM, Soyisim=Cem, Sube=K, Sınıf=11, Isim=Ali}}
         */

        // 102 numaralı ogrencinin saoyadini yazdirin

        System.out.println( ogrenciMap.get(102).get("Soyisim") );  // Cem

        // 103 numaralı ogrencinin sınıfını 12 yapın

        ogrenciMap.get(103).put("Sınıf","12");
        System.out.println(ogrenciMap.get(103).get("Sınıf")); // 12

        // 102 numarali ogrencinin bolumunu yazdirin

        System.out.println( ogrenciMap.get(102).get("Bolum") ); // TM

        // 102 numaralı ogrencinin bolumunu MF yapin
