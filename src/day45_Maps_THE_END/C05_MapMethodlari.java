...
public class C05_MapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(harfler); // {B=40, C=50, T=20, Z=80, K=20}
        // harfler.put("M",30);
        // eger replace yapilmak istenen key, mapde var ise
        // replace ile put ayni işlevi gorur 35-36.satir
        // eger replace yapilmak istenen key, mapde yok ise
        // replace null dondurur ve mape eklemez
        // pu ise her durumda ekler
